...
<kendo:window name="RegistrarCliente" title="Registrar Cliente" modal="true" 
	...
	<div class="container">
		...
		<div class="row row-padding-bottom-all">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 remove-padding-right-col-md">
				...
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 remove-padding-lateral-col-md">
					<input type="text" class="k-textbox full-width" name="txtNombreReg" id="txtNombreReg" />
				</div>
			</div>
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 remove-padding-lateral-col-md">Apellidos</div>
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 remove-padding-lateral-col-md">
					<input type="text" class="k-textbox full-width" name="txtApellidoReg" id="txtApellidoReg" />
				</div>
			</div>
		...
		<div class="row row-padding-bottom-all">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 remove-padding-right-col-md">
				...
				<div class="col-xs-12 col-sm-7 col-md-8 col-lg-8 remove-padding-lateral-col-md">
					<kendo:dropDownList name="cbxTipoClienteReg" style="width:100%" 
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					...
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 remove-padding-lateral-col-md">
						<kendo:dropDownList name="cbxSexoReg" style="width:100%" 
						optionLabel="Seleccione" dataTextField="nombre" dataValueField="id">
						<kendo:dataSource>
						</kendo:dataSource>
					</kendo:dropDownList>
		...
		<div class="row row-padding-bottom-all">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 remove-padding-right-col-md">
				...
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 remove-padding-lateral-col-md">
					<kendo:dropDownList name="cbxEstadoCivilReg" style="width:100%" 
						optionLabel="Seleccione" dataTextField="nombre" dataValueField="id">
						<kendo:dataSource>
						</kendo:dataSource>
					</kendo:dropDownList>
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				...
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 remove-padding-lateral-col-md">
					<input type="text" class="k-textbox full-width" name="txtCorreoReg"  id="txtCorreoReg" maxlength="100"/>
				</div>
			</div>
		</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="pull-right">
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 remove-padding-right-col-md">
						<kendo:button name="btnAceptarRegProducto" click="AceptarRegistrarCliente" class="full-width">Aceptar</kendo:button>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 remove-padding-right-col-md">
						<kendo:button name="btnCancelarRegProducto" click="CancelarRegistrarCliente" class="full-width">Cancelar</kendo:button>
					</div>
				</div>
			</div>
		</div>
