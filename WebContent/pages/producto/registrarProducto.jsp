...
<kendo:window name="RegistrarProducto" title="Registrar Producto" modal="true" 
	...
	<div class="container">
		...
		<div class="row row-padding-bottom-all">
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				...
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 remove-padding-lateral-col-md">
					<kendo:dropDownList name="cbxClienteReg" style="width:100%" 
		...
		<div class="row row-padding-bottom-all">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 remove-padding-right-col-md">
				...
				<div class="col-xs-12 col-sm-7 col-md-8 col-lg-8 remove-padding-lateral-col-md">
					<kendo:dropDownList name="cbxTipoProductoReg" style="width:100%" 
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					...
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 remove-padding-lateral-col-md">
						<input type="text" class="k-textbox full-width" name="txtCantidadReg" id="txtCantidadReg" />
					</div>
			</div>
		</div>
		...
		<div class="row row-padding-bottom-all">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 remove-padding-right-col-md">
				...
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 remove-padding-lateral-col-md">
					<input type="text" class="k-textbox full-width" name="txtPrecioReg" id="txtPrecioReg" />
				</div>
			</div>
		</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="pull-right">
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 remove-padding-right-col-md">
						<kendo:button name="btnAceptarRegProducto" click="AceptarRegistrarProducto" class="full-width">Aceptar</kendo:button>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 remove-padding-right-col-md">
						<kendo:button name="btnCancelarRegProducto" click="CancelarRegistrarProducto" class="full-width">Cancelar</kendo:button>
					</div>
				</div>
			</div>
		</div>
